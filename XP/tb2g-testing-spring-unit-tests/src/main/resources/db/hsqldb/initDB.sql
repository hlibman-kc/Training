...
CREATE
INDEX vets_last_name ON vets (last_name);
...
CREATE
INDEX specialties_name ON specialties (name);
...
CREATE
INDEX types_name ON types (name);
...
CREATE
INDEX owners_last_name ON owners (last_name);
...
CREATE
INDEX visits_pet_id ON visits (pet_id);
