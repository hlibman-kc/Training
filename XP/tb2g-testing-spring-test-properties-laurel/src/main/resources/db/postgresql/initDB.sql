...
(
    ...
    CONSTRAINT pk_vets PRIMARY KEY
(
    id
)
    );
...
CREATE
INDEX IF NOT EXISTS idx_vets_last_name ON vets (last_name);
...
CREATE
INDEX IF NOT EXISTS idx_specialties_name ON specialties (name);
...
CREATE
INDEX IF NOT EXISTS idx_types_name ON types (name);
...
CREATE
INDEX IF NOT EXISTS idx_owners_last_name ON owners (last_name);
...
(
    ...
    CONSTRAINT pk_pets PRIMARY KEY
(
    id
)
    );
...
CREATE
INDEX IF NOT EXISTS idx_pets_name ON pets (name);
