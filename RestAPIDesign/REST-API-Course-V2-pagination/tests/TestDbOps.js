...
// Format =>  mongodb+srv://admin:<password>@cluster0.ugjd4.mongodb.net/test?retryWrites=true&w=majority
const DB_USER = "admin"
const DB_PASSWORD = "admin123"
const DB_NAME = "acmetravel"

process.env.DB_URI = "mongodb+srv://"+DB_USER+":"+DB_PASSWORD+"@cluster0.ugjd4.mongodb.net/"+DB_NAME+"?retryWrites=true&w=majority"
